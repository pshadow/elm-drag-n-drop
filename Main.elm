...
type alias Image =
    { url : String, size : Size, offset : Position }
...
initialModel =
    ...
    , frame =
        HorizontalSplit
            { top =
                SingleImage
                    { url = "http://adipositasmagazin.com/wp-content/uploads/2016/01/beetles-994211_1280.jpg"
                    , size = { width = 1280, height = 849 }
                    , offset = { x = 0, y = 0 }
                    }
            , topHeight = 80
            , bottom =
                HorizontalSplit
                    { top =
                        SingleImage
                            { url = "http://www.gettyimages.com/gi-resources/images/Homepage/Hero/US/Oct2015/GettyImages-564792021_h1-Small[10].jpg"
                    ...
                    , bottom =
                        SingleImage
                            { url = "http://www.islands.com/sites/islands.com/files/styles/medium_4x3/public/images/2016/01/virgin_islands_national_park.jpg?itok=nx4_2HFY"
...
viewCanvas borderSize size rootFrame =
    Html.div
        ...
        [ Html.div [ Html.Attributes.style [ ( "border", toString borderSize ++ "px solid " ++ borderColor ) ] ]
            [ viewFrame []
                borderSize
    ...
    case frame of
            ...
            in
                Html.div
                    [ Html.Attributes.style
                        ...
                        , ( "background-position"
                          , toString -image.offset.x
                                ++ "px "
                                ++ toString -image.offset.y
                                ++ "px"
                          )
                        ]
        ...
        HorizontalSplit { top, topHeight, bottom } ->
            Html.div
                ...
                [ viewFrame (0 :: path)
                    borderSize
                    { width = size.width, height = topHeight }
                    top
                , Html.div
                    [ Html.Attributes.style
                        [ ( "width", toString size.width ++ "px" )
